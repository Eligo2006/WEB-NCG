...
{
  icon: Package,
  title: 'Control de Mercaderías',
  text: 'Verificación detallada de cada ítem en su inventario.'
},
{
  icon: TrendingUp,
  title: 'Rentabilidad Operativa',
  text: 'Reducción de pérdidas y optimización de espacios.'
},
{
  icon: ShieldCheck,
  title: 'Integridad de Datos',
  text: 'Garantizamos la exactitud de sus registros para auditorías impecables.'
}];
    ...
    <main className="relative min-h-screen bg-background">
      ...
      <div ref={pageRef}>
        ...
        <section
          ...
          aria-label="Encabezado Toma de Inventario de Almacén o Existencias">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              ...
              <Icon name="ChevronRightIcon" size={14} className="text-orange-400/60" />
              <span className="text-sm font-semibold text-primary">Almacén y Existencias</span>
            </div>
            ...
            <h1
              ...
              Toma de Inventario de Almacén:{' '}
              <span className="text-primary">Control absoluto</span> de su cadena de valor.
            </h1>
            ...
            <p
              ...
              Evite quiebres de stock y mermas ocultas. Transformamos el desafío de gestionar
              sus mercaderías en una ventaja competitiva para su negocio.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
              ...
              <div className="flex flex-col gap-7">
                ...
                <p
                  ...
                  style={{ transitionDelay: '80ms' }}>
                  Una gestión precisa de sus bienes es vital para la salud operativa de su empresa.
                  Nuestro servicio asegura la verificación exhaustiva de las mercaderías que forman
                ...
                <p
                  className="reveal-up text-base lg:text-lg text-gray-600 leading-relaxed"
                  style={{ transitionDelay: '160ms' }}>
                  Le damos visibilidad total sobre sus existencias para que su base de datos refleje
                  fielmente la realidad física, eliminando riesgos financieros y asegurando que cada
                  decisión de compra o venta esté respaldada por información confiable y actualizada.
                </p>
              ...
              <div
                ...
                <div className="relative z-10 w-full rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img
                    src="https://img.rocket.new/generatedImages/rocket_gen_img_1117753a2-1764661967558.png"
                    alt="Almacén logístico amplio con operarios usando escáneres y montacargas para gestión de inventario de existencias"
                  ...
                  <div className="absolute bottom-6 left-6 bg-white rounded-xl shadow-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-extrabold text-gray-900 leading-none">Stock 100% Verificado</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-28 bg-slate-50" aria-label="Beneficios del servicio de almacén">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2
                ...
                style={{ transitionDelay: '0ms' }}>
                ¿Por qué confiar en{' '}
                <span className="text-primary">NCG</span> para su almacén?
              </h2>
              <p
                className="reveal-up mt-4 text-base lg:text-lg text-gray-500 max-w-xl mx-auto"
                style={{ transitionDelay: '80ms' }}>
                Resultados concretos que impactan directamente en la rentabilidad de su operación.
              </p>
            </div>
        ...
        <section className="py-20 bg-primary" aria-label="Llamada a la acción">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2
              ...
              style={{ transitionDelay: '0ms' }}>
              ¿Listo para tener el control total de su almacén?
            </h2>
            <p
              className="reveal-up mt-4 text-base sm:text-lg text-orange-100 max-w-xl mx-auto"
              style={{ transitionDelay: '80ms' }}>
              Contáctenos hoy y un especialista en gestión de inventarios le diseñará una solución
            ...
            <div
              ...
              <a
                href="/contacto"
                className="inline-flex items-center gap-2 bg-white text-gray-900 font-bold text-base px-9 py-4 rounded-xl hover:bg-orange-50 transition-all duration-200 shadow-lg hover:-translate-y-0.5">
