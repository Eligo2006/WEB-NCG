...
import { ArrowRight, Camera, FolderOpen, Eye } from 'lucide-react';
import Icon from '../ui/AppIcon';

const benefits = [
{
  icon: Camera,
  title: 'Captura Detallada',
  text: 'Registro fotográfico individualizado por cada activo inventariado.'
},
{
  icon: FolderOpen,
  title: 'Álbum Digital',
  text: 'Entrega de un catálogo ordenado y de fácil acceso para su organización.'
},
{
  icon: Eye,
  title: 'Evidencia de Estado',
  text: 'Demuestre visualmente las condiciones físicas actuales para seguros o auditorías.'
}];


export default function InventarioFotograficoPage() {
    ...
    <main className="relative min-h-screen bg-background">
      ...
      <div ref={pageRef}>
        ...
        <section
          ...
          aria-label="Encabezado Toma de Inventario Fotográfico Digital">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              ...
              <Icon name="ChevronRightIcon" size={14} className="text-orange-400/60" />
              <span className="text-sm font-semibold text-primary">Inventario Fotográfico</span>
            </div>
            ...
            <h1
              ...
              <span className="text-primary">El respaldo visual innegable</span> de su patrimonio.
            </h1>
            ...
            <p
              ...
              Una imagen vale más que mil registros. Obtenga un catálogo digital detallado que
              garantice la paz mental sobre el estado real de sus activos.
            </p>
        ...
        <section className="py-20 lg:py-28 bg-white" aria-label="Detalle del servicio fotográfico">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
              ...
              <div className="flex flex-col gap-7">
                ...
                <p
                  ...
                  Este servicio funciona como el complemento perfecto para cualquier tipo de toma
                  de inventario físico. Contar con evidencia fotográfica de cada bien le permite
                  respaldar sus registros contables con pruebas visuales irrefutables.
                </p>
                ...
                <p
                  ...
                  Nuestra metodología se caracteriza por capturar en imágenes de alta calidad cada
                  bien inventariado, preparando un álbum fotográfico digital integrado con la
                  información y características específicas de cada activo.
                </p>
              ...
              <div
                ...
                <div className="relative z-10 w-full rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img
                    src="https://img.rocket.new/generatedImages/rocket_gen_img_12d54aa80-1787182541011.png"
                    alt="Fotógrafo profesional utilizando una cámara réflex digital de alta resolución para capturar imágenes de activos en un inventario fotográfico"
                  ...
                  <div className="absolute bottom-6 left-6 bg-white rounded-xl shadow-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-extrabold text-gray-900 leading-none">Registro Visual de Alta Fidelidad</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-28 bg-slate-50" aria-label="Beneficios del inventario fotográfico">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2
                ...
                ¿Por qué elegir el inventario{' '}
                <span className="text-primary">fotográfico digital</span>?
              </h2>
              <p
                className="reveal-up mt-4 text-base lg:text-lg text-gray-500 max-w-xl mx-auto"
                style={{ transitionDelay: '80ms' }}>
                
                Evidencia visual que protege su patrimonio y fortalece sus procesos de auditoría.
              </p>
            </div>
        ...
        <section className="py-20 bg-primary" aria-label="Llamada a la acción">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2
              className="reveal-up text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight"
              style={{ transitionDelay: '0ms' }}>
              
              ¿Listo para documentar visualmente su patrimonio?
            </h2>
            <p
              className="reveal-up mt-4 text-base lg:text-lg text-orange-100 max-w-xl mx-auto"
              style={{ transitionDelay: '80ms' }}>
              
              Solicite una muestra gratuita y descubra cómo nuestro inventario fotográfico digital
              transforma la gestión de sus activos.
            </p>
            <div
