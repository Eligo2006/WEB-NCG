...
import { ArrowRight, Search, TrendingUp, Building2, Scale } from 'lucide-react';
...
const benefits = [
{
  ...
  text: 'Evaluación detallada de características físicas y técnicas de cada activo.'
},
{
  icon: TrendingUp,
  title: 'Estudio de Demanda',
  text: 'Comparativa con proveedores locales y comportamiento del mercado actual.'
},
{
  icon: Building2,
  title: 'Respaldo Financiero',
  text: 'Soporte vital para fusiones, ventas o actualizaciones contables de su empresa.'
}];
    ...
    <main className="relative min-h-screen bg-background">
      ...
      <div ref={pageRef}>
        ...
        <section
          ...
          aria-label="Encabezado Tasación de Activos">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              ...
              <Icon name="ChevronRightIcon" size={14} className="text-orange-400/60" />
              <span className="text-sm font-semibold text-primary">Tasación</span>
            </div>
            ...
            <h1
              ...
              Tasación de Activos:{' '}
              <span className="text-primary">Conozca el valor real y actualizado</span>{' '}
              de su patrimonio
            </h1>
            ...
            <p
              ...
              Asegure que sus estados financieros muestren un reflejo fiel del mercado actual.
            </p>
        ...
        <section className="py-20 lg:py-28 bg-white" aria-label="Detalle del servicio de tasación">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
              ...
              <div className="flex flex-col gap-7">
                ...
                <p
                  ...
                  style={{ transitionDelay: '80ms' }}>
                  Realizamos un análisis profundo de las características de sus activos. Nuestro
                  proceso toma en consideración la información de proveedores locales sobre bienes
                  iguales o semejantes y el comportamiento de la demanda a la fecha.
                </p>

                <p
                  className="reveal-up text-base lg:text-lg text-gray-600 leading-relaxed"
                  style={{ transitionDelay: '160ms' }}>
                  Esto nos permite determinar con exactitud el valor real al cual sus bienes podrían
                  ser enajenados en condiciones normales, garantizando la salud financiera de su
                  empresa.
                </p>
              ...
              <div
                ...
                <div className="relative z-10 w-full rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img
                    src="https://img.rocket.new/generatedImages/rocket_gen_img_19fd7ff48-1767278159508.png"
                    alt="Profesionales en oficina analizando planos y documentos financieros con tablet y calculadora para tasación de activos"
                  ...
                  <div className="absolute bottom-6 left-6 bg-white rounded-xl shadow-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-extrabold text-gray-900 leading-none">Valor Justo de Mercado</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-28 bg-slate-50" aria-label="Beneficios del servicio de tasación">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2
                className="reveal-up text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900"
                style={{ transitionDelay: '0ms' }}>
                ¿Por qué confiar en nuestra{' '}
                <span className="text-primary">tasación profesional</span>?
              </h2>
              <p
                className="reveal-up mt-4 text-base lg:text-lg text-gray-500 max-w-xl mx-auto"
                style={{ transitionDelay: '80ms' }}>
                Metodología rigurosa y respaldo técnico para decisiones financieras sólidas.
              </p>
            </div>
        ...
        <section className="py-16 bg-primary" aria-label="Llamada a la acción tasación">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2
              className="reveal-up text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-4"
              style={{ transitionDelay: '0ms' }}>
              ¿Listo para conocer el valor real de sus activos?
            </h2>
            <p
              className="reveal-up text-base lg:text-lg text-orange-100 mb-8 max-w-xl mx-auto"
              style={{ transitionDelay: '80ms' }}>
              Nuestros especialistas le brindan un informe de tasación preciso y alineado con el
              mercado actual.
            </p>
            <div
              className="reveal-up"
              ...
              <a
                href="/contacto"
                className="inline-flex items-center gap-2 bg-white text-gray-900 font-bold text-base px-9 py-4 rounded-xl hover:bg-gray-100 transition-all duration-200 shadow-lg hover:-translate-y-0.5">
                Cotizar Tasación ahora
                <ArrowRight size={18} />
              </a>
            </div>
          </div>
